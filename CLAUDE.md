...
PRD 끝까지 웨이브로 넓히는 중([ADR-0034](docs/adr/0034-the-road-to-the-full-prd.md)). 지금 도메인 43 ·
Skill 71. 커리큘럼 데이터, 계약, 하네스, Judge/Sandbox, 검증된 문제 107개, Mastery 산식, 백엔드(Spring Boot · PostgreSQL · Flyway), Decision Engine,
