...
| [explain-back.llm.schema.json](explain-back.llm.schema.json) | [ADR-0050](../docs/adr/0050-explain-back-is-analysed-and-not-recorded.md) | **LLM 요청 스키마.** 설명 분석 - 짚은 점 · 빠진 점 · 잘못 이해한 점. 점수 · 숙련도 · 다음 행동 자리가 없다 |
| [explain-back.schema.json](explain-back.schema.json) | [ADR-0050](../docs/adr/0050-explain-back-is-analysed-and-not-recorded.md) | 푼 문제의 설명과 분석. 기록되지 않는다 |
